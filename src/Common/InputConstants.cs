namespace AntiIdle.Common
{
	public static class InputConstants
	{
		...
		public const string UI_COLORPICKER_DELETE_PRESET = "ui_colorpicker_delete_preset";
		public const string ARENAZ = "arenaZ";
		...
		public const string UI_TEXT_DELETE_WORD__MACOS = "ui_text_delete_word.macos";
		public const string UI_GRAPH_FOLLOW_LEFT__MACOS = "ui_graph_follow_left.macos";
		public const string UI_GRAPH_DUPLICATE = "ui_graph_duplicate";
		public const string UI_UNICODE_START = "ui_unicode_start";
		public const string UI_TEXT_SUBMIT = "ui_text_submit";
		public const string ARENAQ = "ArenaQ";
		public const string ARENAX = "ArenaX";
		public const string UI_TEXT_CARET_PAGE_DOWN = "ui_text_caret_page_down";
		public const string UI_TEXT_SKIP_SELECTION_FOR_NEXT_OCCURRENCE = "ui_text_skip_selection_for_next_occurrence";
		...
		public const string UI_TEXT_CARET_LINE_START__MACOS = "ui_text_caret_line_start.macos";
		public const string UI_TEXT_CARET_WORD_LEFT__MACOS = "ui_text_caret_word_left.macos";
		public const string UI_TEXT_CARET_ADD_BELOW__MACOS = "ui_text_caret_add_below.macos";
		public const string UI_TEXT_CARET_LINE_END__MACOS = "ui_text_caret_line_end.macos";
		...
		public const string UI_TEXT_CARET_ADD_ABOVE__MACOS = "ui_text_caret_add_above.macos";
		...
		public const string UI_TEXT_CARET_DOCUMENT_START__MACOS = "ui_text_caret_document_start.macos";
		public const string UI_TEXT_BACKSPACE_WORD__MACOS = "ui_text_backspace_word.macos";
		public const string UI_TEXT_CARET_WORD_RIGHT__MACOS = "ui_text_caret_word_right.macos";
		public const string UI_TEXT_CARET_WORD_RIGHT = "ui_text_caret_word_right";
		public const string UI_TEXT_SCROLL_UP__MACOS = "ui_text_scroll_up.macos";
		public const string ARENAV = "ArenaV";
		public const string UI_TEXT_DELETE_ALL_TO_RIGHT__MACOS = "ui_text_delete_all_to_right.macos";
		...
		public const string UI_TEXT_BACKSPACE_ALL_TO_LEFT__MACOS = "ui_text_backspace_all_to_left.macos";
		public const string UI_PASTE = "ui_paste";
		public const string UI_FOCUS_MODE = "ui_focus_mode";
		public const string UI_GRAPH_DELETE = "ui_graph_delete";
		public const string UI_MENU = "ui_menu";
		public const string UI_ACCESSIBILITY_DRAG_AND_DROP = "ui_accessibility_drag_and_drop";
		...
		public const string ARENAW = "ArenaW";
		public const string UI_TEXT_CARET_DOCUMENT_END__MACOS = "ui_text_caret_document_end.macos";
		...
		public const string UI_TEXT_SELECT_WORD_UNDER_CARET__MACOS = "ui_text_select_word_under_caret.macos";
		public const string UI_TEXT_CARET_PAGE_UP = "ui_text_caret_page_up";
		public const string ARENAF = "ArenaF";
		public const string ARENAS = "ArenaS";
		public const string ARENAA = "ArenaA";
		public const string UI_GRAPH_FOLLOW_LEFT = "ui_graph_follow_left";
		public const string UI_TEXT_CARET_DOWN = "ui_text_caret_down";
		public const string ARENAC = "ArenaC";
		public const string UI_SWAP_INPUT_DIRECTION = "ui_swap_input_direction";
		public const string ARENAD = "ArenaD";
		public const string P = "p";
		public const string UI_TEXT_SCROLL_DOWN__MACOS = "ui_text_scroll_down.macos";
		public const string UI_REDO = "ui_redo";
		public const string UI_FILEDIALOG_REFRESH = "ui_filedialog_refresh";
		public const string UI_GRAPH_FOLLOW_RIGHT = "ui_graph_follow_right";
		...
		public const string ARENAB = "ArenaB";
		public const string UI_GRAPH_FOLLOW_RIGHT__MACOS = "ui_graph_follow_right.macos";
	}
}