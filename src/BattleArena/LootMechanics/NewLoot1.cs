...
public partial class NewLoot1 : FlashNode2D
{
    private int i;
    private int yy;
    private int mm;
    ...
    private float xVel = (float)Math.random() * 2;
    ...
    public void getLoot()
    {
        ...
        //_root.house.arena
        GetNode<Arena>("/house/arena")
            .showDamage("Coin +" + _root.withComma(amntToGain), 16776960, _X, _Y - 20);
    }
