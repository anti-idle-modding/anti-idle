...
// MATCH: DefineSprite_158_newLoot2-frame_1-DoAction.as
public partial class NewLoot2 : FlashNode2D
{
    private int i;
    private int yy;
    private int mm;
    ...
    // MATCH: DefineSprite_158_newLoot2-frame_1-DoAction.as:getLoot()
    public void getLoot()
    {
        ...
        this.GetArena()!
            .showDamage("Green Coin +" + _root.withComma(amntToGain), 65280, _X, _Y - 20);
    }
