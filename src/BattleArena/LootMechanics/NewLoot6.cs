...
// MATCH: DefineSprite_172_newLoot6-frame_1-DoAction.as
public partial class NewLoot6 : FlashNode2D
{
    private int i;
    private int yy;
    private int mm;
    ...
    // MATCH: DefineSprite_172_newLoot6-frame_1-DoAction.as:getLoot()
    public void getLoot()
    {
        ...
        while (i <= _root.todayEvent)
        {
            ...
            if (
                ...
                == "4x Crafting Material from loot drops in Battle Arena"
            )
            {
                lootValue *= 4;
            }
        ...
        this.GetArena()!
            .showDamage("Crafting Material +" + _root.withComma(amntToGain), 10629939, _X, _Y - 20);
    }
