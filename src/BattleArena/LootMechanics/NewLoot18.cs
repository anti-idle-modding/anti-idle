...
// MATCH: DefineSprite_1335_newLoot18-frame_1-DoAction.as
public partial class NewLoot18 : FlashNode2D
{
    private int i;
    private int yy;
    private int mm;
    ...
    // MATCH: DefineSprite_1335_newLoot18-frame_1-DoAction.as:getLoot()
    public void getLoot()
    {
        ...
        while (i <= _root.todayEvent)
        {
            ...
            if (
                ...
                == "4x Enhancer Fragment from loot drops in Battle Arena"
            )
            {
                lootValue *= 4;
            }
        ...
        this.GetArena()!
            .showDamage("Enhancer Fragment +" + _root.withComma(amntToGain), 8553090, _X, _Y - 20);
    }
