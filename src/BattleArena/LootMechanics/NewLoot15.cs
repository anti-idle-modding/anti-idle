    ...
    public void getLoot()
    {
        if (_root.save.questType == "Loot")
        {
            if (
                ...
                || _root.save.questSubtype == "Chaotic Fragment of Chaos"
            )
            {
        ...
        while (i <= _root.todayEvent)
        {
            ...
            if (
                ...
                == "4x Chaotic Fragment of Chaos from loot drops in Battle Arena"
            )
            {
                lootValue *= 4;
            }
        ...
        _root.house.arena.showDamage(
            "Chaotic Fragment of Chaos +" + _root.withComma(amntToGain),
            16721703,
            _X,
            _Y - 20
        );
