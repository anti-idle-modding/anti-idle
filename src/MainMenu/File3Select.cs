...
public partial class File3Select : FlashButton
{
    AnimationPlayer anim;

    // MATCH: frame_11-PlaceObject2_2379_60-CLIPACTIONRECORD onClipEvent(load).as:checkFrame()
    ...
    // MATCH: frame_11-PlaceObject2_2379_60-CLIPACTIONRECORD onClipEvent(enterFrame).as
    public override void _Process(double delta)
    {
        checkFrame();
    }

    // MATCH: frame_11-PlaceObject2_2379_60-CLIPACTIONRECORD onClipEvent(load).as
    ...
    // MATCH: frame_11-PlaceObject2_2379_60-CLIPACTIONRECORD on(release).as
