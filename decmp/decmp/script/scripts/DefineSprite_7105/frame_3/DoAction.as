...
{
   _root.gainCyborgPoint(Math.floor(4 + _root.stadiumDifficulty * 2));
   i = 1;
...
baseExp = 500 + _root.stadiumDifficulty * _root.stadiumDifficulty * 300;
baseCoin = 500 + _root.stadiumDifficulty * _root.stadiumDifficulty * 600;
baseGreenCoin = 4000 + _root.stadiumDifficulty * 2000;
baseBlueCoin = 8 + _root.stadiumDifficulty * 4;
baseToken = 150 + _root.stadiumDifficulty * _root.stadiumDifficulty * 50;
...
_root.gainCareerEXP(7,Math.floor(250 + (75 + _root.stadiumDifficulty * _root.stadiumDifficulty * 25 + (5 - _root.stadiumOrder) * 50) * (100 + fReward) / 100 / _root.stadiumOrder) + Math.max(300 - _root.stadiumTimer * 20,0),true);
...
_root.dispNews(103,"Simple Race COMPLETE! - Position: #" + _root.stadiumOrder + " - Time: " + Math.floor(_root.stadiumTimer * 100) / 100 + " sec.");
_root.dispNews(103,"Gained: " + _root.withComma(finalExp) + " EXP + " + _root.withComma(finalCoin) + " Coins");
if(_root.stadiumOrder == 1)
{
   if(_root.save.questType == "Simple Race")
   {
