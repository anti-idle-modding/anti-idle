   ...
   function death()
   {
      ...
      else if(_root.save.arenaZone == 52)
      {
         ...
         if(_root.save.arenaSpookyToday < _root.areaSpookyKill)
         {
            ...
            if(_root.save.arenaSpookyToday == 1000)
            {
               ...
               _root.getArenaAccessory(_root.save.arenaLevel,"Pendant",5,itemAttack,itemSpeed,itemDefense,itemCrit,itemDexterity,itemHealth,1,0,1,0,10,itemBonusPow,"Random","Random","Random",250000,Infinity,false,true,false,false,20,"Immortal Pendant","An item awarded for reaching a kill streak of 1,000 in Spooky Crypt.");
            }
            if(_root.save.arenaSpookyToday == 2000)
            {
               _root.getArenaEnhancer("Accessory Unobtainium Enhancer",380,10,0,100,"","","",0,2506,0,172800000,"Accessory Unobtainium Enhancer Lv. 10","An item awarded for reaching a kill streak of 2,000 in Spooky Crypt.");
            }
            if(_root.save.arenaSpookyToday >= 5000 && _root.save.arenaSpookyToday % 5000 == 0)
            {
               _root.getArenaEnhancer("Accessory Unique Enhancer",420,50,0,100,"","","",0,706,0,172800000,"Accessory Unique Enhancer Lv. 50","An item awarded for reaching a kill streak of " + _root.withComma(_root.save.arenaSpookyToday) + " in Spooky Crypt.");
            }
         }
      ...
      else if(_root.save.arenaZone == 68)
      {
         ...
         if(_root.save.arenaTriangleToday < _root.areaTriangleKill)
         {
            ...
            {
               _root.getArenaEnhancer("Armor Unique Enhancer",410,10,0,100,"","","",0,1337,0,172800000,"Armor Unique Enhancer Lv. 10","An item awarded for reaching a kill streak of 100 in Triangle Hideout.");
            }
            if(_root.save.arenaTriangleToday == 200)
            {
               _root.getArenaEnhancer("Weapon Unique Enhancer",400,10,0,100,"","","",0,1337,0,172800000,"Weapon Unique Enhancer Lv. 10","An item awarded for reaching a kill streak of 200 in Triangle Hideout.");
            }
            if(_root.save.arenaTriangleToday >= 500 && _root.save.arenaTriangleToday % 500 == 0)
            {
               _root.getArenaEnhancer("Accessory Unique Enhancer",420,100,0,100,"","","",0,1337,0,172800000,"Accessory Unique Enhancer Lv. 100","An item awarded for reaching a kill streak of " + _root.withComma(_root.save.arenaTriangleToday) + " in Triangle Hideout.");
            }
         }
      ...
      if(name == "THE MEGABOSS" && ultra != true && !isNaN(_root.raidBonus))
      {
         ...
         {
            careerExpGain += 600;
            _root.getArenaWeapon(500,"Trophy",299,false,1337,50,500,90,90,0,1,0,1,0,6,500,"Random","Random","Random",2500000,1296000000,false,true,true,false,false,10,"Unobtainium Trophy","A trophy awarded for beating The Special Arena with a score of " + _root.withComma(_root.raidTimeLeft * 1000) + " " + diffDisplay + ".");
         }
         else if(_root.raidBonus >= 5)
         {
            careerExpGain += 500;
            _root.getArenaWeapon(350,"Trophy",298,false,1237,50,400,80,80,0,1,0,1,0,7,400,"Random","Random","Random",1000000,1296000000,false,true,true,false,false,9,"Platinum Trophy","A trophy awarded for beating The Special Arena with a score of " + _root.withComma(_root.raidTimeLeft * 1000) + " " + diffDisplay + ".");
         }
         else if(_root.raidBonus >= 4)
         {
            careerExpGain += 400;
            _root.getArenaWeapon(250,"Trophy",195,false,1137,50,300,70,70,0,1,0,1,0,8,300,"Random","Random","Random",500000,1296000000,false,true,true,false,false,8,"Gold Trophy","A trophy awarded for beating The Special Arena with a score of " + _root.withComma(_root.raidTimeLeft * 1000) + " " + diffDisplay + ".");
         }
         else if(_root.raidBonus >= 3)
         {
            careerExpGain += 300;
            _root.getArenaWeapon(180,"Trophy",194,false,1037,50,200,60,60,0,1,0,1,0,9,200,"Random","Random","Random",250000,1296000000,false,true,true,false,false,7,"Silver Trophy","A trophy awarded for beating The Special Arena with a score of " + _root.withComma(_root.raidTimeLeft * 1000) + " " + diffDisplay + ".");
         }
         else if(_root.raidBonus >= 2)
         {
            careerExpGain += 200;
            _root.getArenaWeapon(120,"Trophy",193,false,937,50,100,50,50,0,1,0,1,0,10,100,"Random","Random","Random",100000,1296000000,false,true,true,false,false,6,"Bronze Trophy","A trophy awarded for beating The Special Arena with a score of " + _root.withComma(_root.raidTimeLeft * 1000) + " " + diffDisplay + ".");
         }
         careerExpGain += 400;
      }
      ...
      while(i <= _root.todayEvent)
      {
         ...
         dd = _root.clock_date;
         if(_root.eventList[yy][mm][dd][i] == "Receive Event Tokens by killing boss monsters" && boss == true)
         {
            _root.gainEventToken(1);
         }
         if(_root.eventList[yy][mm][dd][i] == "Receive Event Tokens by killing undead monsters" && zombie == true)
         {
            _root.gainEventToken(1);
         }
         i++;
      ...
      if(_root.save.arenaZone == 24)
      {
         ...
         else
         {
            ...
            if(_root.areaDefendStage == 5 && _root.save.arenaHealth >= 200)
            {
               ...
               _root.getArenaAccessory(400,"Earring",14,megaPow,15,0,0,0,0,75,750000000,1,0,0,Math.floor(megaPow * 5 / 2),"Random","Random","Random",75000000,Infinity,true,false,false,false,35,"MEGA EARRINGS","An item awarded for clearing MEGA Defend Mission with a score of " + _root.withComma(tempScore) + ".",false);
