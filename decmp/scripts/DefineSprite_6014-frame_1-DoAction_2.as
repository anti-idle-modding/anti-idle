...
function subFunction1()
{
   ...
   while(i <= 530)
   {
      if(_root.save.inventoryName[i] == "Perfect Attendance" && _root.save.inventoryExist[i] == 1 && dilStack < 2 && _root.save.inventoryExpiry[i] > _root.systemtimenow && _root.save.inventoryDesc[i] != "This medal\'s name depends on your Anti-Idle title when you craft it. Don\'t ask how that works." && _root.save.inventoryDesc[i] != "Thank you for your donation and your continued support!")
      {
         dilStack += 1;
         _root.abilPixel += 10;
         _root.abilHP += 10;
      ...
      if(_root.save.inventoryName[i] == "Dominator Gem" && _root.save.inventoryExist[i] == 1 && domStack < 1 && _root.save.inventoryDesc[i] != "This medal\'s name depends on your Anti-Idle title when you craft it. Don\'t ask how that works." && _root.save.inventoryDesc[i] != "Thank you for your donation and your continued support!")
      {
         domStack += 1;
         _root.abilCoin += Math.floor(Math.min(_root.save.arenaSpookyScore / 500,50));
      }
      if(_root.save.inventoryName[i] == "Mega Triangle Gem" && _root.save.inventoryExist[i] == 1 && megStack < 1 && _root.save.inventoryDesc[i] != "This medal\'s name depends on your Anti-Idle title when you craft it. Don\'t ask how that works." && _root.save.inventoryDesc[i] != "Thank you for your donation and your continued support!")
      {
         megStack += 1;
         _root.abilExp += Math.floor(Math.min(_root.save.arenaTriangleScore / 50,50));
      }
      if(_root.save.inventoryName[i] == "Mission Kommander\'s Gem" && _root.save.inventoryExist[i] == 1 && komStack < 1 && _root.save.inventoryDesc[i] != "This medal\'s name depends on your Anti-Idle title when you craft it. Don\'t ask how that works." && _root.save.inventoryDesc[i] != "Thank you for your donation and your continued support!")
      {
         komStack += 1;
   ...
   while(i <= 3)
   {
      ...
      else if(_root["allyPassive" + i] == "EXP")
      {
         _root.allyExp += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Coin")
      {
         _root.allyCoin += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Pixel")
      {
         _root.allyPixel += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Reflect")
      {
         _root.allyReflect += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Drop Rate")
      {
         _root.allyDropRate += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Spawn Rate")
      {
         _root.allySpawnRate += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Attack %")
      {
         _root.allyAttack += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Defense %")
      {
         _root.allyDefense += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "MaxHP %")
      {
         _root.allyHP += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "MaxMP %")
      {
         _root.allyMP += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Accuracy %")
      {
         _root.allyAccuracy += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Evasion %")
      {
         _root.allyEvasion += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Equipment Attack")
      {
         _root.allyEquipAttack += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Equipment Defense")
      {
         _root.allyEquipDefense += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Attack Speed")
      {
      ...
      else if(_root["allyPassive" + i] == "Mastery")
      {
         _root.allyMastery += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Resist")
      {
         _root.allyDamageTaken += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Hit Chance")
      {
         _root.allyHitChance += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Dodge Chance")
      {
         _root.allyDodgeChance += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Critical Chance")
      {
         _root.allyCriticalChance += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Critical Damage")
      {
         _root.allyCriticalDamage += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Magic Resist")
      {
         _root.allyMagicResist += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Double Hit Chance")
      {
         _root.allyDoubleHit += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Instant Kill")
      {
         _root.allyInstantKill += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Boss Damage")
      {
         _root.allyBossDamage += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Non-Boss Damage")
      {
         _root.allyNonBossDamage += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Damage")
      {
         _root.allyNonBossDamage += _root["allyPassive" + i + "X"];
         _root.allyBossDamage += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Ignore Defense")
      {
         _root.allyIgnoreDefense += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Potion Efficiency")
      {
         _root.allyPotionEfficiency += _root["allyPassive" + i + "X"];
      }
      else if(_root["allyPassive" + i] == "Negate Effect")
      {
